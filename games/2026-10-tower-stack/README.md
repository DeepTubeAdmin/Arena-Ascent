...
- Speed: 5% faster every row (integer table), from a deliberate 256ms/column
  opening down to a 32ms/column floor at row 34 — narrow rows at floor
  speed are beyond human timing (hard cap 60 rows / 6 minutes).
